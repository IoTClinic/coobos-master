...
/*_____IoTClinic_____
    //putstring("cc2530");
*/
    putstring("------------------------------------------------------\n Connected Objects Operating System (Coobos)\n Mainboard:\tCEB-1.0\n CPU:\t\tCC2530\n Coprocessors:\tAES/CSMA\n RAM:\t\t08KB SRAM\n Flash:\t\t256KB\n Peripherals:\t2X Push Button\n \t\t3X LED (RYG)\n \t\tReset Push Button\n \t\tBattery Monitor Interface (BMI)\n \t\tAuto Select Power Supply (ASPS)\n \t\tAuto Charger Circuit (ACC)\n \t\tVirtual Communication Port (USB-CDC)\n \t\tProgrammer/Debugger Port\n Radio:\t\t2.4GHz/802.15.4\n------------------------------------------------------\n\n");
//___________________
    break;
  case 0xB5:
    putstring("cc2531");
